...
<a class="btn btn-small btn-success" href="{{ URL::to('${common.get_plural(entity_name)}/create') }}">Create</a>
...
% endfor
			...
			<td>
				...
				<a class="btn btn-small btn-info" href="{{ URL::to('${common.get_plural(entity_name)}/' . $value->sid . '/edit') }}"><span class="glyphicon glyphicon-pencil"></span></a>
