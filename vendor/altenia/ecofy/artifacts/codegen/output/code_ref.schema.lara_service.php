 ...
 */
class CodeRefService extends BaseService {
	 ...
	 * @return Response
	 */
	public function listCodeRefs($queryParams, $offset = 0, $limit=100)
	{
		$query = \CodeRef::query();
	 ...
	 * @return CodeRef
	 */
	public function findCodeRef($id)
	{
		$record = \CodeRef::find($id);
	 ...
	 */
	public function updateCodeRef($id, $data)
	{
		$validator = \CodeRef::validator($data);
        if ($validator->passes()) {
            $record = \CodeRef::find($id);
	 ...
	 */
	public function destroyCodeRef($id)
	{
		// delete
		$record = \CodeRef::find($id);
		if (!empty($record)) {
