 ...
 */
class OrganizationApiController extends \BaseController {
	...
	public function index()
	{
		...
		$records = $this->organizationService->listOrganizations($qparams, $offset, $limit);
	...
	{
		// delete
		$result = $this->organizationService->destroyOrganization($id, $data);
