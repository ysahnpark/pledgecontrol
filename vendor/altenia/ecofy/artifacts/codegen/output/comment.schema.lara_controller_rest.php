...
/**
 * Controller class that provides REST API to Comment resource
 *
...
class CommentApiController extends \BaseController {
	...
	public function index()
	{
		...
		$records = $this->commentService->listComments($qparams, $offset, $limit);
	...
	{
		// delete
		$result = $this->commentService->destroyComment($id, $data);
