 ...
 */
class SequenceNumberServiceMongo extends BaseServiceMongo {
    ...
    {
    	parent::__construct('sequence_number');
    }
	 ...
	 * @return Response
	 */
	public function listSequenceNumbers($criteria, $sortParams = array(), $offset = 0, $limit=100)
	{
	 ...
	 */
	public function findSequenceNumber($criteria)
	{
	 ...
	 * @return SequenceNumber
	 */
	public function findSequenceNumberByPK($pk)
	{
		$criteria = array( '_id' => new \MongoId($pk) );
        return $this->findSequenceNumber($criteria);
	}
	 ...
	 */
	public function updateSequenceNumber($pk, $data)
	{
		$validator = \SequenceNumber::validator($data);
        if ($validator->passes()) {
            $record = $this->findSequenceNumberByPK($pk);
            $record->fill($data);
	 ...
	 */
	public function destroySequenceNumber($pk)
	{
		$record = $this->findSequenceNumberByPK($pk);
		if (!empty($record)) {
		    $criteria = array( '_id' => new \MongoId($pk) );
