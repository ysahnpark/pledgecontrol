 ...
 */
class CustomFieldServiceMongo extends BaseServiceMongo {
	 ...
	 * @return Response
	 */
	public function listCustomFields($criteria, $sortParams = array(), $offset = 0, $limit=100)
	{
	 ...
	 */
	public function countCustomFields($criteria)
	{
	 ...
	 * @return CustomField
	 */
	public function findCustomField($criteria)
	{
	 ...
	 * @return CustomField
	 */
	public function findCustomFieldByPK($pk)
	{
		$criteria = array( '_id' => new \MongoId($pk) );
        return $this->findCustomField($criteria);
	}
	 ...
	 */
	public function updateCustomField($pk, $data)
	{
		$validator = \CustomField::validator($data);
        if ($validator->passes()) {
            $record = $this->findCustomFieldByPK($pk);
            $record->fill($data);
	 ...
	 */
	public function destroyCustomField($pk)
	{
		$record = $this->findCustomFieldByPK($pk);
		if (!empty($record)) {
		    $criteria = array( '_id' => new \MongoId($pk) );
