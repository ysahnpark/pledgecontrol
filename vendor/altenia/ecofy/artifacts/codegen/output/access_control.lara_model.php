...
class AccessControl extends Eloquent {
	 ...
	 * @var array
	 */
    protected $fillable = array('uuid','domain_sid','domain_id','created_by','created_dt','updated_by','updated_dt','update_counter','lang','role_sid','service','permissions','policy','params_text');
    ...
    private static $validation_rules_create = array(
		...
		'policy' => 'required|alpha_dash|min:2'
    	);
