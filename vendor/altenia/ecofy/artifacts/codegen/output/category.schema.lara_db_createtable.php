...
/**
 * Issue this command: $php artisan migrate:make create_category_table --create=category
 * Then copy/paste the content to the file generated on app/database/migrations/<timestamp>-create_category_table.php
